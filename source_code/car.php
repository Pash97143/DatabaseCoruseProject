            ...
            <div class="product-small col has-hover product type-product post-14552 status-publish first instock product_cat-color has-post-thumbnail shipping-taxable purchasable product-type-simple">
                <div class="col-inner">
                    ...
                    <div>
                        ...
                        ?>
                            <div>
                                <a href="./addToCart.php?CarID=<?php echo $data['CarID']; ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                    <!-- <input type="hidden" name="shoppingCart" value="<?php echo $data['CarID']; ?>" class="car" /> -->
                                    <button id="col-123">按我加入購物車</button>
