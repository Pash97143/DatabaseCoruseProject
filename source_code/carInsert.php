    ...
    <div id="wrapper">
        ...
        <main id="main" class="">
            ...
            <div style="margin: 40px 50% 0 8%;font-size: small;">
                <form action="carInsertSuccess.php" method="post">
                    車輛品牌: &nbsp;<input type="text" name="Brand"><br>
                    車輛款式: &nbsp;<input type="text" name="Model"><br>
                    出產年分: &nbsp;<input type="text" name="Age"><br>
                    車輛價格: &nbsp;<input type="text" name="Price"><br>
                    存放位置: &nbsp;<input type="text" name="Location"><br>
                    行駛距離: &nbsp;<input type="text" name="Distance"><br>
                    圖片位置: &nbsp;<input type="text" name="Image"><br>
                    備註訊息: &nbsp;<input type="text" name="Note"><br>

                    <input type="submit" value="車輛上架">
                </form>
            </div>
