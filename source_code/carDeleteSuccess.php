...
if (!isset($_POST['CarID']) || !isset($_POST['Username']) || !isset($_POST['UPassword'])) {
    echo '請輸入完整資訊';
?>
        ...
        <main id="main" class="">
            ...
            <div>
                <div style="margin: 50px 50% 0 8%;">
                    <?php
                    $sql2 = sprintf('DELETE FROM CAR WHERE CarID = %s', $CarID);
                    $result2 = mysqli_query($con, $sql2);
                    if (mysqli_affected_rows($con) > 0) {
                    ?>
                        <h3 style="margin: 60px 50% 0 8%;">車輛下架成功</h3>
                    <?php

                        echo "車輛編號為 {$CarID} 的車已經下架";
                    } elseif (mysqli_affected_rows($con) == 0) {
                    ?>
                        <h3 style="margin: 60px 50% 0 8%;">車輛下架失敗</h3>
                        <span>無資料異動</span>
                    <?php
                    } else {
                    ?>
