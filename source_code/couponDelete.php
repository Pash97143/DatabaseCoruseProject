...
<body>
    ...
    <div id="wrapper">
        ...
        <main id="main" class="">
            ...
            <div style="margin: 40px 50% 0 8%; font-size: big;">
                <form action="./couponDeleteSuccess.php" method="post">
                    刪除優惠券編號: &nbsp;<?php echo $_POST['CouponID']; ?><br><br>
                    員工帳號:　 &nbsp;<input type="text" name="Username"><br>
                    員工密碼:　 &nbsp;<input type="password" name="UPassword"><br>
                    <input type="hidden" name="CouponID" value="<?php echo $_POST['CouponID']; ?>">
                    <input type="submit" value="優惠券下架">
                </form>
            </div>
