...
<body>
    ...
    <div id="wrapper">
        ...
        <main id="main" class="">
            <h3 style="margin: 50px 50% 0 8%;">
                輸入上架優惠券資訊
            </h3>
            <div style="margin: 40px 50% 0 8%;font-size: small;">
                <select name="CouponType" style="flex-wrap: nowrap;" form="coupon insert">
                    <option value="1">免運費訂單優惠</option>
                    <option value="2">季節性訂單優惠</option>
                    <option value="3">特殊節日商品優惠</option>
                </select>
                <form action="./couponInsertSuccess.php" method="post" id="coupon insert">
                    <!-- 優惠類型: &nbsp;<input type="text" name="CouponType"><br> -->
                    <!-- 優惠券代碼: &nbsp;<input type="text" name="CouponCode"><br> -->
                    起始時間: &nbsp;<input type="date" name="StartTime"><br>
                    結束時間: &nbsp;<input type="date" name="EndTime"><br>
                    使用金額限制: &nbsp;<input type="text" name="UsageLimit"><br>
                    折扣金額: &nbsp;<input type="text" name="Discount" value="0"><br>
                    優惠描述: &nbsp;<input type="text" name="Descriptions"><br>

                    <input type="submit" value="優惠券上架">
                </form>
